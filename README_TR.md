# Dakser Bilgisayar Dijital Kartvizit PWA

Bu paket, yüklenen **Dakser Bilgisayar logosunu değiştirmeden** `assets/logo.png` olarak kullanır. Android ve iPhone'da tarayıcıdan açılır; HTTPS üzerinde yayınlandığında ana ekrana uygulama olarak eklenebilir ve çevrimdışı önbellek desteği sunar.
...
- Profil fotoğrafı başlangıçta boş gelir; istenirse **solda** görünecek şekilde JPG/PNG/WEBP dosyasından profil resmi ekleme, önizleme ve kaldırma.
...
1. GitHub'da yeni bir **Public** repository oluşturun (ör. `dakser-kart`).
...
5. Oluşan `https://KULLANICI-ADI.github.io/dakser-kart/` adresini açın.
...
- Kartta yalnızca paylaşılması uygun kurumsal iletişim bilgilerini kullanın.
